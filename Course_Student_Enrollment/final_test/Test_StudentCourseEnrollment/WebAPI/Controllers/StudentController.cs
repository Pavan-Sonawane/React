...
namespace WebAPI.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        public async Task<IActionResult> Insert(StudentInsertModel StudentInsertModel)
        {
        ...
        public async Task<IActionResult> Update(StudentUpdateModel StudentUpdateModel)
        {
            if (ModelState.IsValid)
            {
