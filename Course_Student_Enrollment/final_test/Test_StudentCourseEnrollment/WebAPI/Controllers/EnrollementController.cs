...
namespace WebAPI.Controllers
{
    ...
    public class EnrollementController : ControllerBase
    {
        ...
        public async Task<IActionResult> Insert(EnrollementInsertModel EnrollementInsertModel)
        {
        ...
        public async Task<IActionResult> Update(EnrollementUpdateModel EnrollementUpdateModel)
        {
            if (ModelState.IsValid)
            {
